...
## NAT网关使用优化升级 {#section_wfp_3bg_q46 .section}
...
对于2018年1月26日23：59分之前账号下没有NAT带宽包的全部用户，使用流程升级为EIP绑定NAT网关的形式。EIP绑定NAT网关的详细信息，请参见[绑定EIP](../../../../intl.zh-CN/用户指南/管理EIP/绑定EIP.md#)。
