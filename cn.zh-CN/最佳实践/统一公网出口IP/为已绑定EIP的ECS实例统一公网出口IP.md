...
绑定了EIP的ECS实例所在的VPC已经配置了SNAT功能。详细信息，请参见[创建SNAT条目](../cn.zh-CN/快速入门/创建SNAT条目.md#)。
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/570281/156099855049564_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/570109/156099855049551_zh-CN.png)
...
2.  执行`ssh root@公网IP`命令，然后输入Linux实例的登录密码，查看是否可以远程连接到实例。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/570109/156099855049595_zh-CN.png)
...
2.  执行`curl https://myip.ipip.net`查看公网出口IP。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/570109/156099855149596_zh-CN.png)
