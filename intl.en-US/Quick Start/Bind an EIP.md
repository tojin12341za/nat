...
-   You have already created an EIP. For more information, see [Apply for an EIP address](../../../../intl.en-US/User Guide/Apply for an EIP address.md#).
...
5.   In the displayed dialog box, complete these configurations: 
    ...
    2.   **VSwitches \(Optional\)**: An SNAT rule using the selected VSwitch and EIP is automatically added if you select a VSwitch. Then, the ECS instances in the specified VSwitch can access the Internet using the EIP. 
